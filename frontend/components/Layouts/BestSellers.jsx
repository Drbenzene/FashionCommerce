        ...
        <div className="pb-16">
            <div className="bg-gray-100 flex flex-col justify-center items-center pt-9 sm:pt-12 lg:pt-16 pb-24 sm:pb-52">
                <div className="2xl:container 2xl:mx-auto flex flex-col justify-center items-center sm:pb-12 lg:pb-0 space-y-4 px-4 md:px-6 2xl:px-0">
                    ...
                    <div>
                        <p className="text-base leading-normal sm:leading-none text-center text-gray-600">Explore some of our best and frequently bought products</p>
                    </div>
                </div>
            </div>
            <div className="-mt-16 sm:-mt-48 lg:-mt-32 xl:-mt-40 2xl:container 2xl:mx-auto flex justify-center items-center space-y-4 px-4 md:px-6 2xl:px-0 mb-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-items-between gap-x-6 gap-y-5 mx-20">
                    {products && products.slice(0,12).map((product, index) =>(
                                            <div className="flex flex-col justify-center items-start p-2 bg-white" key={index}>
                                            <div className="relative">
                                                <img className="hidden flex justify-center lg:block" src={product.image} alt={product.name} width="200px" height = "150px" />
                                                <img className="lg:hidden" src={product.image} alt={product.name} width="200px" height = "150px" />
                    
                                                <button className="top-0 right-1 absolute p-3.5 text-gray-600 hover:text-gray-500 flex justify-center items-center bg-white rounded-full">
                                                ...
                                                <div className="flex justify-between mt-4">
                                                    <div>
                                                        <p className="text-md font-medium leading-none text-gray-800">{truncate(product.name, 40)}</p>
                                                    </div>
                                                    <div>
                                                        <p className="text-lg leading-none text-right text-gray-600">{product.price_string
}</p>
                                                    </div>
                                                </div>
                                            </div>
